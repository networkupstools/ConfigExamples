...
% | left-even  centre-even right-even | left-odd centre-odd right-odd | 
% '-------------------------------------------------------------------'
\lhead[TLS Shims 1.2]{TLS Shims 1.2}                          % \lhead[left-header-even]{left-header-odd}
\chead[ConfigExamples \Version]%
      {ConfigExamples \Version}                               % \chead[centre-header-even]{centre-header-odd}
\rhead[Build \isodate]{Build \isodate}                        % \rhead[right-header-even]{right-header-odd}
\lfoot[]{}                                                    % \lfoot[left-footer-even]{left-footer-odd}
...
% | left-even  centre-even right-even | left-odd centre-odd right-odd | 
% '-------------------------------------------------------------------'
\lhead[TLS \UPSmon\ 1.2]{TLS \UPSmon\ 1.2}                    % \lhead[left-header-even]{left-header-odd}
\chead[ConfigExamples \Version]%
      {ConfigExamples \Version}                               % \chead[centre-header-even]{centre-header-odd}
\rhead[Build \isodate]{Build \isodate}                        % \rhead[right-header-even]{right-header-odd}
\lfoot[]{}                                                    % \lfoot[left-footer-even]{left-footer-odd}
...
simply as an observer with the master/slave shutdown decisions taken
elsewhere.
...
\li When the sum of the \texttt{POWERVALUE} in a group with status \OL\ does
not meet the group's \texttt{MINSUPPLIES} requirement, \UPSmon\ raises status
\LS.  In \upsmon\ this is implicit in the client's logic.
...
\Clunk[ST506]  & \verb`MONITOR heartbeat POWERVAL 0 UPSDUSER upsmaster PASSWORD «sekret» TYPE primary` \\
